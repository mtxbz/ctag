package org.ctag.back.app.endpoint.web;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = org.ctag.back.app.endpoint.web.TestApplication.class)
